...
#testing_top, testing_bottom = training_factory.get_top_bottom_by_indices( 'wpg_data.csv', (53,54,-608,-607) )
testing_top, testing_bottom = training_factory.get_top_bottom_by_indices( 'wpg_data.csv', (53,73,-540,-520) )
